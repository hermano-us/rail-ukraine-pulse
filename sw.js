const CACHE="rail-pulse-v6-osm-routes";
const SHELL=["./","./index.html","./css/styles.css","./css/enhancements.css","./css/ukraine.css","./js/app-ukraine.js?v=20260809-osm-public-routes"];
